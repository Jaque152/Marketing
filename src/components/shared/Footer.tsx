...
export function Footer() {
  ...
  const footerLinks = {
    services: [
      ...
      { name: "Estrategias Base", href: `/${locale}/services` },
      { name: "Planes a la medida", href: `/${locale}/pricing` },
    ],
    company: [
      { name: "Contacto", href: `/${locale}/contact` },
      { name: "Soporte", href: `/${locale}/contact` },
    ],
    legal: [
      { name: "Aviso de Privacidad", href: `/${locale}/legal/privacy` },
      { name: "Términos de Servicio", href: `/${locale}/legal/terms-conditions` },
      { name: "Política de Cancelación", href: `/${locale}/legal/cancellation` },
    ],
  };
    ...
    <footer className="relative bg-[var(--navy)] border-t border-[var(--copper)]/10 font-sans">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          {/* Links Sections */}
          <div>
            <h4 className="text-[var(--cream)] font-serif font-semibold mb-4 text-lg">Servicios</h4>
          ...
          <div>
            <h4 className="text-[var(--cream)] font-serif font-semibold mb-4 text-lg">Empresa</h4>
            <ul className="space-y-3">
        ...
        <div className="mt-16 pt-8 border-t border-[var(--copper)]/10">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-[var(--cream)]/40 text-sm">
              © {new Date().getFullYear()} Marketing Digital. Todos los derechos reservados.
            </p>
